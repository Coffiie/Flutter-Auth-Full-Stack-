...
class _$LoginImpl extends _Login {
  const _$LoginImpl({required this.token, required this.isAuthenticated})
      : super._();
  ...
  @override
  String toString() {
    return 'Login(token: $token, isAuthenticated: $isAuthenticated)';
  }
...
abstract class _Login extends Login {
  const factory _Login(
      ...
      required final bool isAuthenticated}) = _$LoginImpl;
